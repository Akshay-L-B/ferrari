     ...
     console.log(appliedStudentIDs);
      try {
        ...
        for (const student of enrolledStudents) {
          ...
          text: `You have been successfully enrolled to the event: ${slug} - ${eventData.CourseTitle}
          The Course Registration Deadline is ${eventData.CourseRegDeadline} and The Course Drop Deadline is ${eventData.CourseDropDeadline}`,
          };
  ...
  <div className="">
    ...
    <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
      ...
      <div className="sm:col-span-4">
        ...
        <div className="mt-2">
          <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
            <input type="text" name="CourseTitle" id="CourseTitle"  className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900  focus:ring-0 sm:text-lg sm:leading-6" value={eventData.CourseTitle}
      ...
      <div class="mt-5 space-y-10">
        <div class="mt-2 space-y-1">
          <label htmlFor="eventCredits" class="block text-lg font-bold leading-6 text-gray-900">Course Type</label>
          <select
            id="CourseType"
            name="CourseType"
...
<label htmlFor="eventRegDeadline" class="block text-lg font-large font-bold leading-6 text-gray-900">Course Registration Deadline</label>
<div class="mt-2">
  ...
  <input
    ...
    value={new Date(eventData.CourseRegDeadline).toISOString().split('T')[0]}
    onChange={handleInputChange}
  />
</div>
</div>
<div class="sm:col-span-2">
<label htmlFor="eventDropDeadline" class="block text-lg font-large font-bold leading-6 text-gray-900">Course Drop Deadline</label>
<div class="mt-2">
  <input
    type="date"
    ...
    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-lg sm:leading-6"
    value={new Date(eventData.CourseDropDeadline).toISOString().split('T')[0]}
    onChange={handleInputChange}
  />
</div>
</div>
  ...
  <div className="mt-5 space-y-10">
    <div className="mt-2 space-y-1">
      <label htmlFor="eventCredits" className="block text-sm font-bold leading-6 text-gray-900">Course Credits</label>
      <select
        id="eventCredits"
        name="eventCredits"
